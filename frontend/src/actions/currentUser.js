...
export const login = (credentials, history) => {
  return (dispatch) => {
    return fetch("http://techapppiano.herokuapp.com/api/v1/login", {
      credentials: "include",
      method: "POST",
      headers: {
...
export const getCurrentUser = () => {
  return (dispatch) => {
    return fetch("http://techapppiano.herokuapp.com/api/v1/get_current_user", {
      credentials: "include",
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const logout = () => {
  return (dispatch) => {
    ...
    return fetch("http://techapppiano.herokuapp.com/api/v1/delete", {
      credentials: "include",
      method: "DELETE",
    });
  };
...
export const signup = (credentials, history) => {
  return (dispatch) => {
    ...
    return fetch("http://techapppiano.herokuapp.com/api/v1/signup", {
      credentials: "include",
      method: "POST",
      headers: {
        "Content-type": "application/json",
