...
export const addAppointment = (userId, customerId, history, credentials) => {
  ...
  return (dispatch) => {
    return fetch(
      `https://techapppiano.herokuapp.com/api/v1/users/${userId}/customers/${customerId}/appointments`,
      {
        credentials: "include",
        method: "POST",
        headers: {
...
export const appointmentsList = (userId) => {
  return (dispatch) => {
    return fetch(`https://techapppiano.herokuapp.com/api/v1/users/${userId}/appointments`, {
      credentials: "include",
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const patchAppointmentInfo = (
  ...
  return (dispatch) => {
    ...
    return fetch(
      `https://techapppiano.herokuapp.com/api/v1/users/${userId}/customers/${customerId}/appointments/${appointmentId}`,
      {
        credentials: "include",
        method: "PATCH",
        headers: {
...
export const destroyAppointment = (
  ...
  return (dispatch) => {
    ...
    return fetch(
      `https://techapppiano.herokuapp.com/api/v1/users/${userId}/appointments/${appointmentId}`,
      {
        credentials: "include",
        method: "DELETE",
        headers: {
