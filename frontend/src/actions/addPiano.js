...
export function addPiano(userId, customerId, data) {
  // const url = `https://techapppiano.herokuapp.com/api/v1/users/${userId}/customers/${customerId}/pianos`;
  return (dispatch) => {
    return fetch(
      `https://techapppiano.herokuapp.com/api/v1/users/${userId}/customers/${customerId}/pianos`,
      {
        credentials: "include",
        method: "POST",
        body: data,
...
export const getPianos = (user) => {
  return (dispatch) => {
    return fetch(`https://techapppiano.herokuapp.com/api/v1/users/${user}/pianos`, {
      credentials: "include",
      method: "get",
      headers: {
...
export const patchPianoInfo = (
  ...
  return (dispatch) => {
    ...
    return fetch(
      `https://techapppiano.herokuapp.com/api/v1/users/${userId}/customers/${customerId}/pianos/${pianoId}`,
      {
        credentials: "include",
        method: "PATCH",
        headers: {
